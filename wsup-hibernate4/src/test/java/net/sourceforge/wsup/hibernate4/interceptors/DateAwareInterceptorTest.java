...
import net.sourceforge.wsup.hibernate4.database.TestDateBean;
...
public class DateAwareInterceptorTest
{
    ...
    private static final String[] propertyNames = { "created", "updated", "contents", "other" };
    ...
    public void coverMissingProperties()
    {
        ...
        String[] badPropertyNames = { "Xcreated", "Xupdated", "contents", "other" };

        assertFalse(interceptor.onFlushDirty(bean,
                                             new Long(1),
                                             state,
                                             state,
                                             badPropertyNames,
