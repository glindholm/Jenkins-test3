...
import net.sourceforge.wsup.hibernate4.testSupport.MockingDatabaseInterceptor;
...
public class DatabaseContextImplTest
{
    ...
    public void testCommitExceptionClosesSession()
    {
        ...
        interceptor.setCommitTransactionException(new HibernateException("Commit"));
    ...
    public void testDestroyEatsExceptions()
    {
        ...
        MockingDatabaseInterceptor interceptor = new MockingDatabaseInterceptor();
        interceptor.setRollbackTransactionException(new HibernateException("Rollback"));
    ...
    {
        Blob blob1 = context.createBlob(new byte[] { 1, 2, 3 });
        assertEquals(3L, blob1.length());

        ByteArrayInputStream stream = new ByteArrayInputStream(new byte[] { 4, 5, 6, 7 });
