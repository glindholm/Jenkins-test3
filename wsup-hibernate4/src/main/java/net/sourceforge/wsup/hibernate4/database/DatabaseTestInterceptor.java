...
/**
 * This interface specifies an object that can be inserted into the <code>BaseDatabase</code> so
 * that <code>Session</code>s and <code>Transaction</code>s can be intercepted to have additional
 * behavior. For
 * example, this is a way to add "wrappers" to the real <code>Session</code> and/or
 * <code>Transaction</code> objects so that they will throw exceptions
 * when you want.
 * 
 * @author Kevin Hunter
 * 
