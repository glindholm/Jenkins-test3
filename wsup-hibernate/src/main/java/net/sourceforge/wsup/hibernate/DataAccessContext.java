...
/**
 * This interface provides the query-related methods of a Hibernate
 * <code>Session</code> to a <code>BaseDAO</code>-derived object.
 * 
 * @author Kevin Hunter
 * 
 */
public interface DataAccessContext
{
	 ...
	 * @return <code>true</code> if the entity or proxy is read-only; <code>false</code> if the entity or
	 *         proxy is modifiable.
	 */
