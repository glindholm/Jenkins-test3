...
/**
 * This class implements a <code>DatabaseTestInterceptor</code> that wraps
 * <code>Session</code>s and <code>Transaction</code>s so that exceptions can be
...
public class MockingDatabaseInterceptor extends AbstractDatabaseTestInterceptor
{
	...
	/**
	 * @see net.sourceforge.wsup.hibernate.testSupport.AbstractDatabaseTestInterceptor#interceptOpenDatabase(net.sourceforge.wsup.hibernate.BaseDatabase)
	 */
	@Override
	...
	/**
	 * @see net.sourceforge.wsup.hibernate.testSupport.AbstractDatabaseTestInterceptor#interceptCloseDatabase(net.sourceforge.wsup.hibernate.BaseDatabase)
	 */
	@Override
	...
	/**
	 * @see net.sourceforge.wsup.hibernate.testSupport.AbstractDatabaseTestInterceptor#interceptCreateSession(org.hibernate.Session)
	 */
	@Override
	...
	/**
	 * @see net.sourceforge.wsup.hibernate.testSupport.AbstractDatabaseTestInterceptor#interceptCloseSession(org.hibernate.Session)
	 */
	@Override
	 ...
	 *            <code>HibernateException</code> instance, or <code>null</code>
	 *            to not throw anything.
	 */
	public void setCreateSessionException(
			HibernateException beginSessionException)
	{
	 ...
	 *            to not throw anything.
	 */
	public void setCloseSessionException(
			HibernateException closeSessionException)
	{
	 ...
	 *            to not throw anything.
	 */
	public void setBeginTransactionException(
			HibernateException beginTransactionException)
	{
	 ...
	 *            to not throw anything.
	 */
	public void setCommitTransactionException(
			HibernateException commitTransactionException)
	{
	 ...
	 *            to not throw anything.
	 */
	public void setRollbackTransactionException(
			HibernateException rollbackTransactionException)
	{
	 ...
	 *            to not throw anything.
	 */
	public void setOpenDatabaseException(
			HibernateException openDatabaseException)
	{
	 ...
	 *            to not throw anything.
	 */
	public void setCloseDatabaseException(
			HibernateException closeDatabaseException)
	{
	 ...
	 * 
	 * @return <code>MockSession</code> <code>Class</code>, or <code>null</code>
	 *         if sessions will not be wrapped.
	 ...
	 *            <code>MockSession</code> <code>Class</code>, or
	 *            <code>null</code> if sessions will not be wrapped.
	 * @see #wrapSession(Session)
	 * @see MockSession
	 */
	public void setSessionWrapperClass(
			Class<? extends MockSession> sessionWrapperClass)
	{
	 ...
	 * 
	 * @return <code>MockTransaction</code> <code>Class</code>, or
	 *         <code>null</code> if transactions will not be wrapped.
	 ...
	 *            <code>MockTransaction</code> <code>Class</code>, or
	 *            <code>null</code> if transactions will not be wrapped.
	 * @see #wrapTransaction(Transaction)
	 * @see MockTransaction
	 */
	public void setTransactionWrapperClass(
			Class<? extends MockTransaction> transactionWrapperClass)
	{
	 ...
	 * @return Original session (if sessions not being wrapped) or
	 *         <code>MockSession</code> wrapping that session.
	...
	public Session wrapSession(Session realSession)
	{
		...
		try
		{
			Constructor<? extends MockSession> constructor = sessionWrapperClass
					.getConstructor(MockingDatabaseInterceptor.class,
							Session.class);
