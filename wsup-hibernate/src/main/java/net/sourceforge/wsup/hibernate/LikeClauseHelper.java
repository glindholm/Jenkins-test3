...
public class LikeClauseHelper
{
     ...
     * <code>value</code> contains any SQL wildcard characters ('%','_','[') they will be escaped by prefixing
     ...
     * @param escape the escape character, usually '!'. (Wildcard characters ('%','_','[') are invalid)
