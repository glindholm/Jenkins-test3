...
/**
 * This is a test class that can be used to "wrap" a real Hibernate
 * <code>Session</code> so that exceptions can be thrown when required for
...
public class MockSession implements Session
{
	...
	{
		return realSession.getEntityMode();
	}
	...
	{
		return realSession.getSession(entityMode);
	}
