...
/**
 * Hibernate only supports a single <code>Interceptor</code> on each
 * <code>Session</code>.  This interceptor implements a "fan-out" to
 ...
 * used across multiple <code>Session</code>s, providing that all of
 * the interceptors that it holds are also thread-safe.
 * </p>
 */
@ThreadSafe
