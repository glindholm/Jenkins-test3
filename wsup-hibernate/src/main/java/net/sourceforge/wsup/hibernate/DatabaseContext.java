...
{
	/**
	 * Begin a new <code>Session</code>. This method does nothing if a
	 * <code>Session</code> has already been begun.
	 * 
	 * @param preverify
	 ...
	 *            suggests that the database connection was lost. If
	 *            <code>false</code>, the <code>Session</code> is created but
	 *            not validated before being returned. This will typically be
	 *            fine, but can potentially result in a <code>Session</code>
	 *            being returned with a dead JDBC connection if connections time
	 ...
	 * transaction is already underway. If called before
	 * <code>beginSession</code>, this method will automatically begin a new
	 ...
	 * <p>
	 * This method will assert if there is not a transaction outstanding. For a
	 * "safe" means of rolling back a possibly-outstanding transaction and
	 * closing a session, use {@link #destroySession()}.
	 * </p>
	 * 
	 * @throws HibernateException
	 */
	 ...
	 * <p>
	 * For a "safe" means of rolling back a possibly-outstanding transaction and
	 * closing a session, use {@link #destroySession()}.
	 * </p>
	 * 
	 * @throws HibernateException
	 ...
	 * <p>
	 * Unlike {@link #rollbackTransaction()}, this method is benign if there is
	 * no outstanding transaction. It is also benign if there is no outstanding
	 * session.
	 * </p>
	 * <p>
	 * This method will "eat" any <code>HibernateException</code> that is thrown
	 * by the transaction as it is rolled back, or by the session as it is
	 * closed. It is therefore a safe way of abandoning any database activity
	 * that might have been outstanding. (The exceptions will be logged at the
	 * "info" level.)
	 * </p>
	 */
	 ...
	 * will automatically begin a new session as if
	 * <code>beginSession(false)</code> were called.
	 * 
