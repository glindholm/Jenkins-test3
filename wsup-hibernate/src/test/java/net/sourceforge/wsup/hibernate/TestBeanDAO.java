...
public class TestBeanDAO extends BaseDAO<TestBean, Long>
{
    ...
    {
        Query query = context.createQuery("select t from TestBean t where t.contents like :contents");
    ...
    public List<TestBean> listByNullSafeContents(DataAccessContext context,
                                                 String contents)
    {
        return listDistinctByCriteria(
            context,
