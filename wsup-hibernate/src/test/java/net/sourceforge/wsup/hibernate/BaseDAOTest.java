...
import net.sourceforge.wsup.hibernate.impl.DataAccessContextImpl;
...
public class BaseDAOTest
{
    ...
    public void testClassAndTableName()
    {
        ...
        assertEquals("net.sourceforge.wsup.hibernate.TestBean",
                     testBeanDAO.getPersistentClassName());
        ...
        assertEquals("net.sourceforge.wsup.hibernate.TestDateBean",
                     testDateBeanDAO.getPersistentClassName());
    ...
    public void testEscapedLkeExpression()
    {
        ...
        List<TestBean> results = testBeanDAO
            .listDistinctByCriteria(daoContext,
                                    "comment",
                                    Order.asc("contents"),
                                    new EscapedLikeExpression("contents", "%5"));
